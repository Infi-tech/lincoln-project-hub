defmodule LincolnProjectHubWeb.ProjectControllerTest do
  use LincolnProjectHubWeb.ConnCase

  alias LincolnProjectHub.Dashboard

  @create_attrs %{description: "some description", end_date: "some end_date", name: "some name", start_date: "some start_date"}
